...
insert into MaterialProduto(idMaterial, idProduto, quantidade) values ((SELECT idTipoMaterial FROM material WHERE nome LIKE 'Pérola Branco 5cm'), LAST_INSERT_ID(), 3);
insert into MaterialProduto(idMaterial, idProduto, quantidade) values ((SELECT idTipoMaterial FROM material WHERE nome LIKE 'Papel Fotográfico Branco A3 90'), LAST_INSERT_ID(), 3);
insert into MaterialProduto(idMaterial, idProduto, quantidade) values ((SELECT idTipoMaterial FROM material WHERE nome LIKE 'Renda N 4 m'), LAST_INSERT_ID(), 3);

insert into produto (id, nome, valor, tipo, quantidade) values 
(default, 'Caixa Canudo', 19.99, 'Cartonagem', 100);
insert into MaterialProduto(idMaterial, idProduto, quantidade) values ((SELECT idTipoMaterial FROM material WHERE nome LIKE 'Canudo Verde 26 Canudo(s)'), LAST_INSERT_ID(), 3);
insert into MaterialProduto(idMaterial, idProduto, quantidade) values ((SELECT idTipoMaterial FROM material WHERE nome LIKE 'Papel Fosco Branco A6 75'), LAST_INSERT_ID(), 3);
insert into MaterialProduto(idMaterial, idProduto, quantidade) values ((SELECT idTipoMaterial FROM material WHERE nome LIKE 'Fita Voil N° 1 N° Cor 2 B'), LAST_INSERT_ID(), 3);

insert into produto (id, nome, valor, tipo, quantidade) values 
(default, 'Caixa Shalker', 15.99, 'Cartonagem', 100);
insert into MaterialProduto(idMaterial, idProduto, quantidade) values ((SELECT idTipoMaterial FROM material WHERE nome LIKE 'Papel Colorplus Branco A5 108'), LAST_INSERT_ID(), 3);
insert into MaterialProduto(idMaterial, idProduto, quantidade) values ((SELECT idTipoMaterial FROM material WHERE nome LIKE 'Fita Voil N° 1 N° Cor 2 B'), LAST_INSERT_ID(), 3);
insert into MaterialProduto(idMaterial, idProduto, quantidade) values ((SELECT idTipoMaterial FROM material WHERE nome LIKE 'Pérola Branco 5cm'), LAST_INSERT_ID(), 3);
insert into MaterialProduto(idMaterial, idProduto, quantidade) values ((SELECT idTipoMaterial FROM material WHERE nome LIKE 'Acetato 166 Micra 3 X 3'), LAST_INSERT_ID(), 3);

insert into produto (id, nome, valor, tipo, quantidade) values 
(default, 'Caixa Milk', 12.99, 'Cartonagem', 100);
insert into MaterialProduto(idMaterial, idProduto, quantidade) values ((SELECT idTipoMaterial FROM material WHERE nome LIKE 'Renda N 4 m'), LAST_INSERT_ID(), 3);
insert into MaterialProduto(idMaterial, idProduto, quantidade) values ((SELECT idTipoMaterial FROM material WHERE nome LIKE 'Pérola Azul 12cm'), LAST_INSERT_ID(), 3);
insert into MaterialProduto(idMaterial, idProduto, quantidade) values ((SELECT idTipoMaterial FROM material WHERE nome LIKE 'Fita Cetim N° 1 N° Cor 4 D'), LAST_INSERT_ID(), 3);
insert into MaterialProduto(idMaterial, idProduto, quantidade) values ((SELECT idTipoMaterial FROM material WHERE nome LIKE 'Papel Colorplus Branco A5 108'), LAST_INSERT_ID(), 3);

insert into produto (id, nome, valor, tipo, quantidade) values 
(default, 'Caixa Pirâmide', 19.99, 'Cartonagem', 100);
insert into MaterialProduto(idMaterial, idProduto, quantidade) values ((SELECT idTipoMaterial FROM material WHERE nome LIKE 'Papel Fosco Branco A4 180'), LAST_INSERT_ID(), 3);
insert into MaterialProduto(idMaterial, idProduto, quantidade) values ((SELECT idTipoMaterial FROM material WHERE nome LIKE 'Fita Gorgurão N° 5 N° Cor 4 A'), LAST_INSERT_ID(), 3);
insert into MaterialProduto(idMaterial, idProduto, quantidade) values ((SELECT idTipoMaterial FROM material WHERE nome LIKE 'Fita Cetim N° 1 N° Cor 4 D'), LAST_INSERT_ID(), 3);
insert into MaterialProduto(idMaterial, idProduto, quantidade) values ((SELECT idTipoMaterial FROM material WHERE nome LIKE 'Tecido Feltro Estampado 6 cm'), LAST_INSERT_ID(), 3);
